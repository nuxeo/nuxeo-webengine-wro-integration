...
public class LessCss {
   ...
   */
  public static final String DEFAULT_LESS_JS = "less-1.3.0.js";
  ...
  public LessCss(UriLocatorFactory uriLocatorFactory) {
...
/**
   ...
   */
  public String less(final String data, Resource parentResource) {
    final StopWatch stopWatch = new StopWatch();
    stopWatch.start("initContext");
    final RhinoScriptBuilder builder = initScriptBuilder();
    if(parentResource != null) {
        scope.put("resourceReader", scope, new FromJsResourceReader(parentResource,uriLocatorFactory));
    }
    stopWatch.stop();
